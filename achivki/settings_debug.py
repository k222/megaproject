# Django settings for achivki project.
...
MEDIA_ROOT = PROJECT_ROOT + 'achivki/media'
...
STATIC_ROOT = PROJECT_ROOT + 'achivki/static'
...
SECRET_KEY = 'zm_=%9ivc6fq*g(7c(t5$6oa#t5xti4g^b!c%by$%6b_@4807x'
